           ...
           <div class="readmretext2">
               ...
               <div  style="padding: 20px; background-color: beige;">
                   ...
                   <div style="font-size:12px;  padding-top: 30px; color:#9D9D9D;">
                      <span>{{ecount}}阅读</span>
                      <span style="padding-left:300px;">标签：{{moretext.dynamicTags}}</span>
                                    ...
                                    <span v-else>
                                        <div v-for="(item,i) in ecomment" :key="item.ecid">
                                            <div  class="vcomment" v-if="i<count">
                                                ...
                                                <!-- 有人回复 -->
                                                <div class="vcboxzz">
                                                <span v-if="Object.keys(item.eccomment).length==0">暂时还没有人回复</span>
                                                ...
                                                <span v-else>
                                                    <div v-for="(item2,n) in item.eccomment" :key="item2.eccid">
                                                        ...
                                                        <div class="vcbox2" v-if="item2.ehf">
                                                            <el-input type="textarea"  @focus="Focus2(i,n)" :rows="item2.textfont2" placeholder="回复..." v-model="etextarea3"> </el-input>
...
export default {
    ...
    methods: {
        ...
        getmoretext(){
            ...
            //获取作者名
            this.postRequest("/user/SelectUserid",{id:this.moretext.id}).then(req=>{
                var data=req.data;
                this.aname=data.data.name;
            })
            //获取所有的评论
            this.getEComment()
        },
