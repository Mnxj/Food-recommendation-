    ...
    <div>
        ...
        <div class="readmorevideo">
            <div class="readmorevideo2">
                ...
                <p style="font-size:14px;padding-top: 14px;">{{vcount}}播放·{{sum}}评论</p>
                                            ...
                                            <span v-else>
                                                <div v-for="(item2,n) in item.vccomment" :key="item2.vccid">
                                                    ...
                                                    <div class="vcbox2" v-if="item2.vhf">
                                                        <el-input type="textarea"  @focus="Focus2(i,n)" :rows="item2.textfont2" placeholder="回复..." v-model="vtextarea3"> </el-input>
...
export default {
    ...
    methods: {
        ...
        getreadmorevideo(i){
            this.$router.push({name:'readmorevideo3'});
            localStorage.setItem('video2',JSON.stringify(this.morevideo2[i]))
        },
        VHf(i,n){
        ...
        Focus2(i,n){
             this.vcomment[i].vccomment[n].textfont2=3;
        ...
        getmoreVideo(){
            ...
            this.morevideo=JSON.parse(localStorage.getItem('video'));
        ...
        addCommentcc(i,num){
             this.formdate.vcctext=this.vtextarea3;
